a java based web framework inspired from solid java ee frameworks (J2EE el expression validation and SpringBoot like page context load). works barely with lot of difficulties. 
