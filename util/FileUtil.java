...
public class FileUtil {
    ...
    public static synchronized void writeBytesToFile(byte[] contentBytes, String location) {
    ...
    public static synchronized void writeContentToFile(String content, String location) {
    ...
    public static synchronized void writeContentToFile(String content, String location, Charset charset) {
        try {
